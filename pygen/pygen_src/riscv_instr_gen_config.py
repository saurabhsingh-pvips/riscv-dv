...
class riscv_instr_gen_config:
    def __init__(self):
        ...
        self.vreg_initt_method = vreg_init_method_t.RANDOM_VALUES_VMV
        ...
        self.single_step_iterations = 0  # TODO
    ...
    def default_c(self):
        # TODO
        self.main_program_instr_cnt in vsc.rangelist(vsc.rng(10, self.instr_cnt111))
    ...
    @vsc.constraint
    def addr_translaction_rnd_order_c(self):
        # TODO
        pass

    @vsc.constraint
    def addr_translaction_c(self):
        # TODO
        pass
