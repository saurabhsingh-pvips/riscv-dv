...
class riscv_illegal_instr:
    ...
    def hint_instr_c(self):
        with vsc.if_then(self.exception == illegal_instr_type_e.kHintInstr):
            # C.ADDI
            (self.c_msb == 0 and self.c_op == 1 and self.instr_bin[12] == 0 and self.instr_bin[6:2] == 0) or \
            (self.c_msb == 2 and self.c_op == 1 and self.instr_bin[11:7] == 0) or \
            (self.c_msb == 4 and self.c_op == 1 and self.instr_bin[12:11] == 0 and self.instr_bin[6:2] == 0) or \
            (self.c_msb == 4 and self.c_op == 2 and self.instr_bin[11:7] == 0 and self.instr_bin[6:2] != 0) or \
            (self.c_msb == 3 and self.c_op == 1 and self.instr_bin[11:7] == 0 and self.instr_bin[12] == 0 and self.instr_bin[6:2] != 0) or \
            (self.c_msb == 0 and self.c_op == 2 and self.instr_bin[11:7] == 0) or \
            (self.c_msb == 0 and self.c_op == 2 and self.instr_bin[11:7] != 0 and not self.instr_bin[12] == 1 and self.instr_bin[6:2] == 0) or \
            (self.c_msb == 4 and self.c_op == 2 and self.instr_bin[11:7] == 0 and self.instr_bin[12] and self.instr_bin[6:2] != 0)
