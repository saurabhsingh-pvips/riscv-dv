    ...
    def gen_stack_enter_instr(self):
        ...
        try:
            with vsc.randomize_with(self.program_stack_len):
                self.program_stack_len in vsc.rangelist(vsc.rng(cfg.min_stack_len_per_program, cfg.max_stack_len_per_program))
        ...
        self.instr_stack_enter.gen_push_stack_instr(self.program_stack_len, allow_branch = [allow_branch])
