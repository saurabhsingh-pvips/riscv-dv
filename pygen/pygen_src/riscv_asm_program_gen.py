...
from pygen_src.target.rv32i import riscv_core_setting
import logging
import random
...
class riscv_asm_program_gen:
    ...
    def gen_program(self):
        ...
        for hart in range(cfg.num_of_harts):
            ...
            # To DO
            if(riscv_core_setting.support_pmp and not(cfg.bare_program_mode)):
            ...
            self.main_program[hart].label_name = self.main_program[hart].__init__()
            # self.main_program[hart].cfg = cfg
            ...
            # self.main_program[hart].cfg = cfg # TODO
        ...
        if(hart == 0 and not(riscv_core_setting.support_pmp)):
            self.gen_test_done()
...
>>>>>>> Stashed changes
    ...
    def gen_init_section(self, hart):
        ...
        if (riscv_core_setting.support_pmp):
    ...
    def pre_enter_privileged_mode(self, hart):
        ...
        # print("IN gen_section {}".format(self.instr_stream))
    ...
    def setup_epc(self, hart):
        ...
        # TODO
        mode_name = cfg.init_privileged_mode[3]
        instr.append("csrw mepc, x{}".format(cfg.gpr[0]))
        if(not riscv_core_setting.support_pmp): # TODO
    ...
    def trap_vector_init(self, hart):
        instr = []
        for items in riscv_core_setting.supported_privileged_mode:
            ...
            if(riscv_core_setting.SATP_MODE != "BARE" and items != "MACHINE_MODE"):
                instr.append("slli x{}, x{}, {}\n".format(cfg.gpr[0], cfg.gpr[0], riscv_core_setting.XLEN - 20) +
                             "srli x{}, x{}, {}".format(cfg.gpr[0], cfg.gpr[0], riscv_core_setting.XLEN - 20))
...
>>>>>>> Stashed changes
    ...
    def generate_directed_instr_stream(self, hart=0, label="", original_instr_cnt=None,
        ...
        # for instr_stream_name in directed_instr_stream_ratio:
