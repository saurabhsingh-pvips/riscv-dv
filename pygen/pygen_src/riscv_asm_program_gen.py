...
class riscv_asm_program_gen:
    ...
    def gen_trap_handler_section(self, hart, mode, cause, tvec,
        ...
        instr.append("li x{}, 0x{} # ILLEGAL_INSTRUCTION".format(
            cfg.gpr[1], exception_cause_t.ILLEGAL_INSTRUCTION))
        instr.append("beq x{}, x{}, {}illegal_instr_handler".format(
            cfg.gpr[0], cfg.gpr[1], pkg_ins.hart_prefix(hart)))
        # Skip checking tval for illegal instruction as it's implementation specific
        instr.append("csrr x{}, 0x{} # {}".format(cfg.gpr[1], tval, tval.name))
