...
class riscv_loop_instr(riscv_rand_instr_stream):
    ...
    def post_randomize(self):
        logging.info("DBG : LOOP_CNT_REG {}".format(self.loop_cnt_reg))
        logging.info("DBG : LOOP_INIT_VAL {}".format(self.loop_init_val))
        logging.info("DBG : NUM_OF_NESTED_LOOP {}".format(self.num_of_nested_loop))
        ...
        for i in range(self.num_of_nested_loop):
            ...
            logging.info("LABEL : {} ".format(self.loop_branch_target_instr[i].label))
    ...
    def build_loop_instr_stream(self):
        ...
        for i in range(self.num_of_nested_loop):
            ...
            logging.info("INIT_INSTR_2i = {}, INIT_INSTR_2i_1 = {}, BRANCH_TARGET_INSTR = {}, UPDATE_INSTR = {},  LOOP_INSTR = {}, \
            BRANCH_INSTR = {}".format(self.loop_init_instr[2 * i], self.loop_init_instr[2 * i + 1], self.loop_branch_target_instr[i], \
                self.loop_update_instr[i], self.loop_instr[i], self.loop_branch_instr[i]))
