...
class riscv_loop_instr(riscv_rand_instr_stream):
    ...
    def __init__(self):
        ...
        self.loop_init_val = vsc.randsz_list_t(vsc.int8_t())
        self.loop_step_val = vsc.randsz_list_t(vsc.int8_t())
        self.loop_limit_val = vsc.randsz_list_t(vsc.int8_t())
        self.num_of_nested_loop = vsc.rand_bit_t(8)
        self.num_of_instr_in_loop = vsc.rand_uint8_t(0)
    ...
    def legal_loop_regs_c(self):
        ...
        with vsc.foreach(self.loop_cnt_reg, idx = True) as i:
            ...
            self.loop_cnt_reg[i].not_inside(vsc.rangelist(cfg.reserved_regs))
    ...
    def post_randomize(self):
        ...
        for i in range(self.num_of_nested_loop):
            ...
            try:
                ...
                logging.critical("Cannot randomize loop init instruction")
                sys.exit(1)
