...
class riscv_instr_pkg:
	def __init__(self):
		self.instr_name = ["LUI","AUIPC","JAL","JALR","BEQ","BNE","BLT","BGE","BLTU","BGEU","LB","LH","LW","LBU","LHU","SB"]
...
'''ro = riscv_instr_pkg()
print(ro.instr_group["RV32I"])'''

riscv_instr_pkg_inst = riscv_instr_pkg()
#print(riscv_instr_pkg_inst.group)

#print(riscv_instr_pkg_inst.category)
